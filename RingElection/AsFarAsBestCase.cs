...
{
    public static class AsFarAsBestCase
    {
        public static void Main(string[] args)
        {
            Console.Write("*************************As far as best case test*************************" +
                              "\nThis test will output message cost and time cost of as far as in best case" +
            ...
            Console.WriteLine("As far as best case test started");
            ...
            var file = string.Format("AsFarAsBestCase_{0}{1}{2}{3}{4}.csv",
                timeNow.Minute, timeNow.Hour, timeNow.Day, timeNow.Month, timeNow.Year);

            exporter.ExportToFile(file);
            Console.WriteLine("As far as best case test finished. Results saved in {0}", file);
        }
